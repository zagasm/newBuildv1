...
// import { TestModalButton } from '../../component/assets/ModalContext/test';
                            ...
                            <div style={{ maxWidth: '20px', border: 'none' }} className="dropdown-list dropdown-menu dropdown-menu-left shadow-sm dropdown-menu dropdown-menu-end dropdown-menu-left shadow-sm border-none">
                                <div className="px-3 d-flex align-items-center">
                                    ...
                                    <div className="font-weight-bold " style={{ marginTop: '-20px' }}>
                                        <div className="text-truncate m-0 p-0" style={{ fontWeight: 'lighter' }}>{user.user.last_name} {user.user.first_name}</div>
                                        {/* <div className="small text-gray-500">@{user.user_name}</div> */}
                                    </div>
                                </div>
                                <Link style={{ border: 'none' }} className="dropdown-item border-bottom mb-3" to={"/" + user.user.meta_data.id}><i className=" feather-settings mr-1"></i> Settings</Link>
